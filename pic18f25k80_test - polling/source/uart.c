...
#if defined (__18F8722_H) || defined (__18F25K80_H)
  	data = Read1USART();
#else
  	data = ReadUSART();
#endif
...
void UART2_init(unsigned long baudRate)
{
	...
	Open2USART(  USART_TX_INT_OFF &
				...
				USART_BRGH_HIGH,
				baudRate );
	/* Make USART1 receive interrupt high priority. */
	IPR3bits.RC2IP = 1;
	/* Enable receive 2 interrupt. */
	PIE3bits.RC2IE = 1;
...
#if defined (__18F8722_H) || defined (__18F25K80)
