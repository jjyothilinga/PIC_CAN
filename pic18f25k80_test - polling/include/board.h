...
#define 	SER2_TX					PORTBbits.RB6 		// serial transmit
#define		SER2_TX_DIR				TRISBbits.TRISB6
#define 	SER2_RX					PORTBbits.RB7			// serial receive
#define		SER2_RX_DIR				TRISBbits.TRISB7
...
#define 	CAN_TX					PORTBbits.RB2		// serial transmit
#define		CAN_TX_DIR				TRISBbits.TRISB2
#define 	CAN_RX					PORTBbits.RB3			// serial receive
#define		CAN_RX_DIR				TRISBbits.TRISB3


// HeartBeat
#define		HEART_BEAT				PORTCbits.RC4			// high - OFF, Low - ON
#define		HEART_BEAT_DIR			TRISCbits.TRISC4
...
#define SYSTEM_CLOCK			(64000000UL)	// 8MHz internal oscillator	
